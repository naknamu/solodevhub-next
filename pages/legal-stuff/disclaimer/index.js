      ...
      <Wrapper>
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to Solo Dev Hub.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Solo Dev Hub, accessible from{" "}
            <a
              href="https://www.solodevhub.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.solodevhub.com/
            </a>
          </li>
        </ul>
        <h2>Disclaimer</h2>
